...
package com.example.inventoryservice.controller.config;

import com.example.entities.constant.OrderConstants;
import com.example.inventoryservice.controller.usecase.RollbackOrder;
...
public class ProductConfiguration{
	...
	public ConsumerFactory<String, Object> consumerFactory(){
		...
		props.put(ConsumerConfig.GROUP_ID_CONFIG, OrderConstants.PRODUCT_GROUP);
	...
	@Bean
	RollbackOrder rollbackOrder(KafkaOperations<String, Object> kafkaOperations){
		return new RollbackOrder(kafkaOperations);
	}
